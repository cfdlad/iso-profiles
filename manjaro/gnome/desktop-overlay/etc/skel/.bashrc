...
# cheat and fzf
alias ch='cheat -l | fzf --preview="cheat {1}"'		# Preview only
alias chh="cheat -l | awk '{print \$1}' | fzf --preview='cheat {}'| xargs -I{} cheat {}"	# Preview and paste code
...
# vte fix for tillix (ubuntu only)
